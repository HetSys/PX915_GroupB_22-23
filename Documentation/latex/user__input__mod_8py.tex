...
\begin{DoxyCompactList}\small\item\em Package containing functions to set up user input parameters and execute the solver. \end{DoxyCompactList}\end{DoxyCompactItemize}
