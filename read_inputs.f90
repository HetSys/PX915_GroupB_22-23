    ...
    MODULE read_inputs
        ...
        !! If no arguments or an unrecognised argument are passed, stops execution of code and prints error.
        ...
        !! @param[out] c0: Initial concentration (mol m^-3)
        ...
        SUBROUTINE read_user_inputs(filename, tsteps, dt, n, c0, D, R, a_small, L, iapp, electrode_charge)
            ...
            ! Error checking on read function.
            INTEGER :: ios
